...
I'm a passionate **DevOps Engineer with over **6 years of experience** in building scalable, secure, and highly available cloud platforms. I specialize in automating infrastructure, enabling CI/CD at scale, and ensuring reliability across AWS, Azure.
...
- 🏢 ***GSK * – *Devops engineer*  
  Managing AWS-based infrastructure with Kubernetes. Driving CI/CD and observability strategy across critical internal platforms. Led cloud automation projects using Terraform, Docker, and CI/CD tools (GitHub Actions, Jenkins) on AWS, resulting in a 40% deployment time reduction.

- 🏢 **World Informatix Cyber Security** – *Security Engineer*  
  SOC Analyst L2 with experience in monitoring, analyzing, and responding to security incidents using SIEM tools.
  Skilled in threat detection, incident investigation, and escalation, ensuring timely resolution of security alerts in enterprise environments. 
